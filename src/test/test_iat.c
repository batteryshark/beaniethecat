...
int main(){
    ...
    real_system_1 = flh_import_table_hook_byname(NULL,target_library,"system",(void*)hook_system_1);
    ...
    real_system_2 = flh_import_table_hook_byname(NULL,target_library,"system",(void*)hook_system_2);
